...
**Entrega actual 1.0.3:** cruz médica azul y turquesa, elección del logo de clínica en primer inicio, recuperación mediante contraseña maestra, mínimo de ocho caracteres, calendario corregido, selector de sexo con Masculino/Femenino, CSV de consultas y foto de médico aplicada al guardarla. El MSI `dist/installer/TresVizo-Med-1.0.3-x64.msi` aprobó arranque, iconos, PDF y el ciclo de instalación, actualización, reparación, bloqueo de retroceso, rollback y desinstalación. Se conservaron y reabrieron 21 archivos sintéticos, incluidos foto, logo y recuperación. Se verificaron los 154 archivos fuente del manifiesto y las nueve imágenes del icono incrustadas en el EXE.

La suite final aprobó 130 casos y tuvo un timeout en la prueba de bloqueo de sesión; ese caso pasó aislado en 2,48 segundos. Los 131 casos quedaron verificados entre ambas ejecuciones, sin afirmar una sola ejecución limpia. Un bloque dirigido de 55 pruebas también pasó. Detalle en `dist/installer/TresVizo-Med-1.0.3-x64.verification.json` y [novedades](novedades-1.0.3.md). La instalación habitual no se actualizó durante el ensayo.

**Entrega anterior 1.0.2:** consulta con motivo, diagnóstico e indicaciones a la vista, narrativa opcional y resúmenes clínicos adaptables. El MSI `dist/installer/TresVizo-Med-1.0.2-x64.msi` aprobó 122 pruebas en 143,28 segundos y el ciclo MSI de actualización, reparación, rollback y desinstalación con 11 archivos sintéticos conservados. Iconos y ejecutable instalado verificados. Informe: `dist/installer/TresVizo-Med-1.0.2-x64.verification.json`. La [guía de uso](uso.md) describe esta consulta. Lo siguiente conserva la historia de las entregas anteriores.

Actualización 11/09/2026: está compilado el MSI **1.0.1 x64**, con selección de médicos renovada y acceso de desinstalación en Inicio. Incluye el [recorrido simplificado](recorrido-simple.md): Agenda y Seguimientos retirados y consulta SOAP progresiva. La suite de esta distribución aprobó 120 pruebas en 111,03 segundos. El ejecutable verificó la selección de médicos, los iconos pequeño/grande, la identidad de barra de tareas y PDF. El ensayo MSI final aprobó instalación, actualización con inicio desactivado/activado, reparación, rechazo de retroceso y arquitectura distinta, bloqueo con la app abierta, rollback y desinstalación. Los 11 archivos sintéticos se conservaron y pudieron reabrirse. Informes: `artifacts/release-1.0.1-x64.log`, `artifacts/msi-validation-92c9109e65/result.json` y `dist/installer/TresVizo-Med-1.0.1-x64.verification.json`. El detalle siguiente se conserva como registro de las etapas anteriores.
